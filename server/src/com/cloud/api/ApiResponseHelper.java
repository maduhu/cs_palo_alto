...
public class ApiResponseHelper implements ResponseGenerator {
    ...
    public ServiceResponse createNetworkServiceResponse(Service service) {
        ...
        for (Network.Provider serviceProvider : serviceProviders) {
            // return only Virtual Router/JuniperSRX/PaloAlto as a provider for the firewall
            if (service == Service.Firewall && !(serviceProvider == Provider.VirtualRouter || serviceProvider == Provider.JuniperSRX || serviceProvider == Provider.PaloAlto)) {
                continue;
            }
