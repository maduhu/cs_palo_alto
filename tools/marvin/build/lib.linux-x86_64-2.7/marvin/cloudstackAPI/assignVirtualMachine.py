...
class assignVirtualMachineCmd (baseCmd):
    def __init__(self):
        ...
        """Required"""
        self.domainid = None
        """the vm ID of the user VM to be moved"""
        """Required"""
        self.virtualmachineid = None
        """list of network ids that will be part of VM network after move in advanced network setting."""
        self.networkids = []
        """comma separated list of security groups id that going to be applied to the virtual machine. Should be passed only when vm is moved in a zone with Basic Network support."""
